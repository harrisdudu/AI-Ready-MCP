...
SOURCE_FOLDER = 'P2025082000001_C2025080200001/'
# 文件下载存放目录 TARGET_FOLDER
TARGET_FOLDER = r'F:/2-成品语料库/规资-语料成果-json/解压版/第16批原料-P2025082000001-json'
# TARGET_FOLDER = r'F:/2-成品语料库/规资-语料成果-json/第15批洗料-P2025071100003-json'
    ...
    for page in page_iterator:
        if 'Contents' in page:
            for obj in page['Contents']:
                key = obj['Key']
                if key.endswith('_final.json'):  # 只取
