...
if __name__ == "__main__":
    ...
    parser.add_argument('--output-dir', type=str, default=r"E:/2-成品原料", help='输出文件夹路径')
    parser.add_argument('--source-dir', type=str, default=r"E:/1-原料仓库", help='源文件目录路径')
    parser.add_argument('--excel', type=str, default=r"D:\2 技术资料知识库\Code Rep\特殊处理\商汤加工筛选-管理案例+实务案例-最终.xlsx", help='Excel文件路径')
